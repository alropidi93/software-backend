...
{   
    ...
    public function obtenerProductosConDescuentoDeTienda($idTienda){
        try{
            $tienda = $this->tiendaRepository->obtenerPorId($idTienda);
            if (!$tienda){
                $notFoundResource = new NotFoundResource(null);
            ...
            $lista = $this->descuentoRepository->obtenerProductosConDescuentoDeTienda($idTienda);
            $responseResourse = new ResponseResource(null);
    ...
    public function obtenerCategoriasSinDescuentoDeTienda($idTienda){
        try{
            $tienda = $this->tiendaRepository->obtenerPorId($idTienda);
            if (!$tienda){
                $notFoundResource = new NotFoundResource(null);
            ...
            $lista = $this->descuentoRepository->obtenerCategoriasSinDescuentoDeTienda($idTienda);
            $responseResourse = new ResponseResource(null);
            $responseResourse->title('Lista de categorias sin descuento en esta tienda');  
            $responseResourse->body($lista);
            return $responseResourse;
        }catch(\Exception $e){
            return (new ExceptionResource($e))->response()->setStatusCode(500);
